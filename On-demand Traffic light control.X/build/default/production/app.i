...
# 1 "./app.h" 1
# 12 "./app.h"
# 1 "./ECUAL/ecual_init.h" 1
# 11 "./ECUAL/ecual_init.h"
# 1 "./ECUAL/LED/led.h" 1
# 11 "./ECUAL/LED/led.h"
...
# 13 "./MCAL/INTERRUPT/mcall_interrupt_cfg.h"
...
# 117 "app.c"
    ...
    else if(flag_mode==2 && (PORTCbits.RC5==HIGH)){
        ret=led_off(&car_led_yellow);
        ret=led_off(&pedestrian_led_yellow);
        move_sign();
        ret=led_on(&car_led_red);
